...
<div class="auth-container" style="padding:48px 32px; align-items:flex-start;">
    <div style="width:100%; max-width:540px; margin:0 auto;">
        ...
        <div class="auth-card">
            ...
            <!-- Google Sign Up -->
            <a id="btn-google-signup" href="/api/v1/auth/google?role=client" class="btn-secondary" style="width:100%; display:flex; justify-content:center; align-items:center; gap:12px; margin-bottom:20px; padding:14px;">
...
function pickRole(role, btn) {
    ...
    // Update Google Signup link to include role
    document.getElementById('btn-google-signup').href = '/api/v1/auth/google?role=' + role;
}
